...
The app is locked to landscape, uses an immersive full-screen WebView, has no address/search bar, blocks navigation away from the configured GitHub Pages site, and supports the site's file picker.
